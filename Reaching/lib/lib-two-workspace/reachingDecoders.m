function results = reachingDecoders(td_list,task_list,robot_height,params)
...
%% Set up model variables
    ...
    dec_params = cell(num_models-1,1);
    ...
    %             markername = 'Marker_1';
                ...
                dec_params{modelnum} = struct(...
                    'model_type',model_type,...
                    'model_name',[model_aliases{modelnum} '_model'],...
                    'out_signals',{{'dlc_pos',marker_hand_idx;'dlc_vel',marker_hand_idx}},...
                    'in_signals',neural_signals);
            ...
            case 'handelbow'
                ...
                dec_params{modelnum} = struct(...
                    'model_type',model_type,...
                    'model_name',[model_aliases{modelnum} '_model'],...
                    'out_signals',{{'dlc_pos',[marker_hand_idx marker_elbow_idx];'dlc_vel',[marker_hand_idx marker_elbow_idx]}},...
                    'in_signals',neural_signals);
            ...
            case 'joint'
                ...
                dec_params{modelnum} = struct('model_type',model_type,...
                    'model_name',[model_aliases{modelnum} '_model'],...
                    'out_signals',{{'opensim',[ang_idx, vel_idx]}},...
                    'in_signals',neural_signals);
...
%% Cross-validate models of neural data
    ...
    [crossEval,crossval_lookup,crossval_dec_info] = analyze3DReachDecoders({td_plane,td_freereach},crossval_params);
...
%% create return struct
    ...
    results.params.dec_params = dec_params;
    results.params.crossval_lookup = crossval_lookup;
    results.glm_info = crossval_dec_info;
