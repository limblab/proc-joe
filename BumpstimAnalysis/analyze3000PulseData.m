...
plotRasterStim(cds,nn,'plotSpikeWaveforms',plotWaveforms,'plotArtifacts',plotArtifacts,'stimsPerTrain',1,...
    ...
    'preTime',5/1000,'postTime',20/1000,'timeAfterStimRawNoStim',5/1000,'timeAfterStimRawArtifact',5/1000,...
    ...
    'maxArtifactsPerPlot',2,'plotArtifactsFiltered',[0,1],'stimElectrode',stimElectrode, 'plotWaveformsFiltered',[0,1],...
...
plotPSTHStim(cds,nn,'binSize',0.2/1000,'makeFigure',1,'makeSubplots',0,'plotTitle',1,'stimsPerTrain',10,'stimCenter',1,...
    'waveformTypes',[1:1:numel(unique(cds.waveforms.waveSent))],'chans',[1:1:numel(unique(cds.waveforms.chanSent))],...
    'preTime',20/1000,'postTime',120/1000,'saveFigures',saveFigures,'figDir',figDir,'figPrefix',figPrefix,...
